...
- https://github.com/Yann-cmd[Yann Guillevir]
...
Quelques tests pythons ont été codé pour vous permettre de tester le programmes principal. Vous pourrez les retrouver : 
