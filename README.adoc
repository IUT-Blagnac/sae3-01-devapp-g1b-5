...
__Partie Base de donnée__
 Lien vers les docs BD : https://github.com/IUT-Blagnac/sae3-01-devapp-g1b-5/tree/V1_d%C3%A9but_du_projet/Base%20de%20donn%C3%A9e[ici]


__Partie Développement web__
 Lien vers les docs Dev Web : https://github.com/IUT-Blagnac/sae3-01-devapp-g1b-5/tree/V1_d%C3%A9but_du_projet/Site%20e-commerce%20Cheribou[ici]
...
__Partie Python__
 Lien vers les docs python : https://github.com/IUT-Blagnac/sae3-01-devapp-g1b-5/tree/V1_d%C3%A9but_du_projet/Programmes%20python[ici]
 
 Quelques tests pythons ont été codé pour vous permettre de tester le programmes principale. Vous pourrez les retrouver : 
 https://github.com/IUT-Blagnac/sae3-01-devapp-g1b-5/tree/V1_d%C3%A9but_du_projet/Programmes%20python/Tests[ici]


__Partie Gestion de projet__
 pas encore disponible
