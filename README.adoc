...
- Lien vers la doc utilisateur : https://github.com/IUT-Blagnac/sae3-01-devapp-g1b-5/blob/V2/Site%20e-commerce%20Cheribou/assets/docs/Documentation_utilisateur.adoc[ici]
