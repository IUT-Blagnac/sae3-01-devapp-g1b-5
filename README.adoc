...
|===
|Sprint 5
|https://github.com/IUT-Blagnac/sae3-01-devapp-g1b-5/blob/master/Site%20e-commerce%20Cheribou/assets/docs/Sprint%205/Avancement%20du%20projet%20Dev%20Web%20semaine%2001%20G1B%20-%205.pdf[Livrable avancement du site web]
