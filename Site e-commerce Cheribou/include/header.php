...
<header>
    ...
    <img src="include\images\Logo.png" height=120 alt="image logo" id="logo"></img>
    <h1>CHERIBOU</h1>
    <img src="include\images\DrapeauFR.jpg" height=80 alt="image france" id="imageFR"></img>
            ...
            <li class="deroulant"><a href="#">Bonbons &ensp;</a>
                ...
                <ul class="sous">
                    ...
                    <!-- <li><a href="#">Marques</a></li>
                      ...
                      <li><a href="#">Gouts</a></li> -->
                </ul>
            </li>
            <li><a href="#">Nouveautés</a></li>
            <li><a href="#">Offres</a></li>
            <li><a href="#">Spéciale</a></li>
