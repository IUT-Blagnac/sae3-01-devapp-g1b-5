...
Cette page utilise la base de données avec les tables panier , contientbonbon, contientrecipient, bonbons et recipient
tout d'abord si l'utilisateur c'est pas connecter la page affichera une alert pour lui dire de se connecter et renvera sur la page connexion.

:image::images/panier.png[panier]

si un client arrive sur la page du panier la page verifira le nombre d'article du panier=+
____
-s'il est vide alors affichera votre panier est vide et un boutton qui permettra d'aller sur la page nouveauté 
s'il y a des articles alors l'article sera afficher et des boutton pour abandonner ou valider le panier s'afficherons aussi
____
